...
@section('styles')
	...
	<link rel="stylesheet" type="text/css" href="{{ elixir('css/datatables.css') }}">
	<link rel="stylesheet" type="text/css" href="{{ elixir('css/checkbox3.css') }}">
	<link rel="stylesheet" type="text/css" href="{{ elixir('css/select2.css') }}">
	<link rel="stylesheet" type="text/css" href="{{ elixir('css/dashboard_switch.css') }}">
@stop
		...
		<div class="col-md-10 col-md-offset-1">
			<div class="panel panel-default">
				...
				<div class="panel-body">
					{{ trans('site.login_as', ['name'=>Auth::user()->name]) }}
				</div>
			</div>
		</div>
	</div>
...
@section('scripts')
	...
	<script src="{!! elixir('js/dashboard_switch.js') !!}"></script>
